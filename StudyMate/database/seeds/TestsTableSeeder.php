...
class TestsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('tests')->insert([
            ...
            ['type_id' => 3, 'module_id' => 6, 'name' => Crypt::encrypt('Terugblik presentatie'), 'file' => null, 'grade' => Crypt::encrypt('Voldaan'), 'date' => Crypt::encrypt('2019-4-14 23:00:00'), 'is_complete' => true, 'created_at' => Now(), 'updated_at' => Now()],
